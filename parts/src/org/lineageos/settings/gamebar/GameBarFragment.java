    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        if (mCaptureStartPref != null) {
            mCaptureStartPref.setOnPreferenceClickListener(pref -> {
                ...
                Toast.makeText(getContext(), getContext().getString(R.string.capture_start_toast), Toast.LENGTH_SHORT).show();
                return true;
            });
        }
        if (mCaptureStopPref != null) {
            mCaptureStopPref.setOnPreferenceClickListener(pref -> {
                ...
                Toast.makeText(getContext(), getContext().getString(R.string.capture_stop_toast), Toast.LENGTH_SHORT).show();
                return true;
            });
        }
        if (mCaptureExportPref != null) {
            mCaptureExportPref.setOnPreferenceClickListener(pref -> {
                ...
                Toast.makeText(getContext(), getContext().getString(R.string.capture_export_toast), Toast.LENGTH_SHORT).show();
                return true;
            });
        }
